...
fn is_valid(line: &str, red: usize, green: usize, blue: usize) -> Option<usize> {
    if let Ok((
        _,
        Game {
            game_id,
...
pub fn process(input: &str, red: usize, green: usize, blue: usize) -> usize {
    input
        .lines()
        .filter_map(|line| is_valid(line, red, green, blue))
        .sum()
}
